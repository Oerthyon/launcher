...
function showFatalStartupError(){
    setTimeout(() => {
        $('#loadingContainer').fadeOut(250, () => {
            ...
            setOverlayContent(
                'Erreur Fatal Bazooka: Impossible de chercher l\'index de distribution',
                'Une connexion à nos serveurs n\'a pas pu être établie pour télécharger l\'index de distribution. Aucune copie locale n\'était disponible pour le chargement. <br><br>L\'index de distribution est un fichier essentiel qui fournit les dernières informations sur les serveurs. Le lanceur ne peut pas démarrer sans lui. Assurez-vous que vous êtes connecté à Internet et relancez l\'application.',
                'Fermer'
            )
            setOverlayHandler(() => {
...
async function validateSelectedAccount(){
    ...
    if(selectedAcc != null){
        ...
        if(!val){
            ...
            setOverlayContent(
                'Échec du rafraîchissement de la connexion',
                `Nous n'avons pas pu rafraîchir le login pour <strong>${selectedAcc.displayName}</strong>. Veuillez vous connecter à nouveau.`,
                'Login'
            )
            setOverlayHandler(() => {
